        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompetencyScore = table.Column<int>(nullable: false),
                    CurrentLevel = table.Column<int>(nullable: false),
                    PointsToNext = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubcategoryComments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubcategoryComments_Subcategories_SubCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SubcategoryComments_SubCategoryId",
                table: "SubcategoryComments",
